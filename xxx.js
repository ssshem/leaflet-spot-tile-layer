...
!function () {
    ...
    function i(i, a, r, o, l, c, d) {
        var u, h, m = W.rootScope, f = W.store, p = W.connection, g = Date.now();
        try {
            "error" === i && "object" == typeof a ? (a = (h = a).message,
                r = r || h.filename,
                o = o || h.lineno,
                l = l || h.colno,
                u = h.error && h.error.stack) : c && "object" == typeof c && (r = r || c.fileName || c.sourceURL,
                a = (a && "string" == typeof a ? a : "") + ": " + (c.message || c.errorMessage || c.responseText),
                u = c.stack,
                o = o || c.lineNumber || c.line,
                l = l || c.columNumber || c.column);
            var v, y = c && c.constructor && c.constructor.name || typeof c;
            try {
                v = JSON.stringify(c, Object.getOwnPropertyNames(c), 4)
            } catch (e) {
                v = c.toString() + " (unable to serialize object: " + e.message + ")"
            }
            var w = {
                timestamp: g,
                runningMs: g - t,
                ...
                , b = s(w.msg, 20) || "universal-key"
                , T = 0;
            if ((T = b in n ? n[b]++ : n[b] = 0) % 10 || T > 100)
                return;
            if (T > 0 && (w.msg = "(" + T + "x) " + w.msg,
                w.repeated = T),
            o && w.script && (w.scriptLine = s(w.script, 10) + "-" + o),
            W.latestBcasts && W.latestBcasts.length && (w.latestBcast = W.latestBcasts.map((function (e) {
                    var t = e.ts;
                    return e.txt + " (" + (g - t) + "ms ago at " + t + ")"
                }
            )).join("\n")),
                m) {
                w.uid = m.user && m.user.username;
                var L = W.store && W.store.get("country") || "xx";
                e || (e = L + "-" + (w.uid ? w.uid : m.sessionCounter)),
                    w.sessionName = e,
                    w.sessionCounter = m.sessionCounter,
                    w.lang = W.store && W.store.get("usedLang"),
                    w.retina = m.isRetina,
                    w.size = window.screen.width + "x" + window.screen.height,
                    w.glParticles = m.glParticlesOn,
                    w.platform = m.platform
            }
            "index" === W.target && (window.top !== window.self && (w.target = "unlegalIframe"),
            /Android.* wv\)/.test(window.navigator.userAgent) && (w.target = "unlegalWebView"),
            window.cordova && (w.target = "unlegalCordova")),
                w.errorID = s(w.msg, 60);
            var S = new XMLHttpRequest
                , E = JSON.stringify(w);
            S.open("post", "https://node.windy.com/sedlina/err", !0),
                S.setRequestHeader("Content-type", "application/json; charset=utf-8"),
                S.onreadystatechange = function () {
                    4 === S.readyState && (delete w.uid,
                        window.windySentErrors.push(w))
                }
                ,
                S.send(E)
        } catch (e) {
            console.error("onError handler failed as well...", e)
        }
    }
    ...
    function (e) {
        ...
        function n(i) {
            ...
            i.dependencies.forEach((function (e) {
                    var a = t[e];
                    if (!a)
                        throw new Error("DI error: Module " + e + " not defined. Required by: " + i.name);
                    a.wasLoaded ? s.push(a.loaded) : s.push(n(a))
                }
            ));
            try {
                i.loaded = i.callback.apply(null, s),
                    i.wasLoaded = !0
            } catch (e) {
        ...
        e.require = function (e) {
            if ("string" == typeof e) {
                var i = t[e];
                if (!i)
                    throw new Error('Tinyrequire error: Module "' + e + '" does not exist!');
...
Copyright(c) 2011 Daniel Lamb <daniellmb.com> MIT Licensed */
                    ...
                    emit: function (e, n, i, s, a) {
                        ...
                        if (c)
                            for (var d = c.length; d--;) {
                                var u = c[d];
                                try {
                                    u.callback.call(u.context, n, i, s, a),
                                    u.once && this.off(u.id)
                                } catch (t) {
                        ...
                        if ("number" == typeof e)
                            ...
                            if (r) {
                                for (var o = r.length; o--;)
                                    r[o].callback !== t || n && n !== r[o].context || r.splice(o, 1);
    ...
    W.define("http", ["lruCache", "rootScope", "utils", "broadcast"], (function (e, t, n, i) {
            ...
            l(),
                i.on("tokenRecieved", l.bind(null, !1)),
                i.on("provisionaryToken", l.bind(null, !0)),
                i.on("identityCreated", (function (e) {
                        o = e,
                            l()
                    }
                ));
            var c = function (e) {
                ...
                var f = /^\/?users\//.test(o) || l.withCredentials
                    , p = o;
                if (void 0 === l.cache && "get" === e && (l.cache = !0),
                l.cache && (u = s.get(o)))
                    return Promise.resolve(u) == u ? u : Promise.resolve(c(u));
                var g = new XMLHttpRequest;
                l.timeout && (g.timeout = l.timeout);
                var v = !1;
                if (!/^http/.test(o) && !/^v\/\d+/.test(o) && (o = n.joinPath(t.nodeServer, o),
                /node\.windy/.test(o) && (o = n.addQs(o, a + "&poc=" + ++r)),
                    /^\/?forecast\//.test(p))) {
                    var y = /^(.+)\/forecast\/([^/]+)\/([^/]+)\/(.+)$/.exec(o)
                        ...
                        , T = y[3]
                        , L = b + "/" + T + "/" + y[4];
                    o = w + "/" + ("Zm9yZWNhc3Q/" + window.btoa(T).replace(/=/g, "")) + "/" + window.btoa(L).replace(/=/g, ""),
                        v = !0
                }
                o = encodeURI(o),
                    g.open(e, o, !0),
                l.binary && (g.responseType = "arraybuffer"),
                                ...
                                if (4 === g.readyState)
                                    ...
                                    g.status >= 200 && g.status < 300 || 304 === g.status) {
                                        r = {
                                            ...
                                            l.binary ? r.data = g.response : v ? (r.isJSON = !0,
                                                r.data = window.atob(g.responseText)) : (r.isJSON = /json/.test(g.getResponseHeader("Content-Type")),
                                                r.data = g.responseText),
                                        l.cache && s.put(p, r);
                                        var o = c(r);
                                        e(o)
                                    } else
                                        0 === g.status && i.emit("noConnection", "http"),
                                        l.cache && s.remove(p),
                                            t(g)
                            }
                        }
                ...
                var S = null;
                "post" !== e && "put" !== e || (g.setRequestHeader("Content-type", "application/json; charset=utf-8"),
                    S = JSON.stringify(l.data));
                try {
                    g.send(S)
                } catch (e) {
                    return i.emit("noConnection", "httpError"),
                        Promise.reject(e)
                }
                return l.cache && s.put(p, h),
                    h
            };
            return {
                get: u.bind(null, "get"),
                ...
                getFile: function (n, i) {
                    ...
                    return a && (i.aboluteURL || a.version === e.version) && (!i.test || a.data && a.data[i.test]) ? Promise.resolve(a.data) : new Promise((function (a, r) {
                            t.get(i.aboluteURL ? n : e.assets + "/" + n).then((function (t) {
                                    t.version = i.aboluteURL ? "notAplicable" : e.version,
                                        i.test && !(i.test in t.data) ? r("File did not passed the test") : (s.put(n, t),
                                            a(t.data))
                                }
                            )).catch((function (e) {
    ...
    /*! */
    W.define("subscription", ["store", "http"], (function (e, t) {
            var n = {
                PREMIUM: "premium"
            }
                , i = "subscription"
                , s = "pendingSubscription"
                , a = {};
            a[n.PREMIUM] = {
                activate: function () {
                },
            ...
            var r = function (e) {
                return function (t) {
                    void 0 === t && (t = this.tier);
                    var n = a[t];
                    n && (e ? n.activate : n.deactivate).call(this)
                }
            };
            return Object.assign({
                ...
                set tier(t) {
                    return null === t ? this.deactivateAllFeatures() : (this.deactivateFeatures(this.tier),
                        this.activateFeatures(t),
                        this.clearPendingSubscription(),
                        e.remove("failedSubscriptionPayment")),
                        e.set(i, t),
                        t
                },
                get pendingSubscription() {
                    return e.get(s)
                },
                set pendingSubscription(t) {
                    return e.set(s, t),
                        t
                },
                hasAny: function () {
                    return null !== this.tier
                },
                ...
                redeem: function (e) {
                    var n = this;
                    return t.post("https://account.windy.com/api/redeem-subscription", {
                        data: {
                            redeemCode: e
                        },
                        withCredentials: !0
                            ...
                            throw window.wError("subscription", "Failed to redeem subscription", e),
                                e
                        }
                    ))
                },
                getValidTier: function (e) {
                ...
                activateFeatures: r(!0),
                deactivateFeatures: r(!1),
                deactivateAllFeatures: function () {
                    var e = this;
                    Object.keys(a).forEach((function (t) {
                            e.deactivateFeatures(t)
                        }
                    ))
                }
            }, n)
    ...
    W.define("log", ["ga", "utils", "broadcast", "storage", "store", "rootScope", "seoParser", "router"], (function (e, t, n, i, s, a, r, o) {
            var l = {}
                ...
                /ov|pl|mo|an|pa|de|po|is|ve|le/.test(n) && ("pl" !== n || !/rhpane|picker|patch|detail|pois|user|radar|lhpane|noui|articles/.test(i))) {
                    var a = n + "/" + i + (s ? "/" + s : "");
                    a in c ? c[a]++ : c[a] = 1,
                        d()
                }
    ...
    W.define("ga", ["rootScope", "store", "utils"], (function (e, t, n) {
            ...
            var r = !0
                ...
                if (e.user && (n += "&uid=" + e.user.userslug),
                    r) {
                    var i = document.referrer;
                    /www.windy.com/.test(i) || (n += "&dr=" + encodeURIComponent(i)),
                        r = !1
                }
                setTimeout((function () {
                        var e = new XMLHttpRequest;
                        e.open("HEAD", "https://node.windy.com/sedlina/ga/" + a + "?" + n, !0),
                            e.send(null)
                    }
                ), 100)
            };
            ...
            return t.num2char = function (e) {
                ...
                t.clone = function (e, n) {
                    ...
                    if (null === e || "object" != typeof e)
                        ...
                        for (var r in i = {},
                            e)
                            !e.hasOwnProperty(r) || n && !n.includes(r) || (i[r] = t.clone(e[r]));
                    else
    ...
    /*! */
    W.define("urls", ["rootScope"], (function (e) {
            return {
                getPointForecast: function (t, n, i, s) {
                    var a = n.lat
                        , r = n.lon
                        , o = n.step;
                    return "/forecast/point/" + t + "/" + e.pointForecast + "/" + a + "/" + r + "?source=" + i + (o ? "&step=" + o : "") + (s ? "&" + s : "")
                },
                getMeteogramForecast: function (e, t) {
                    return "/forecast/meteogram/" + e + "/" + t.lat + "/" + t.lon + "?step=" + t.step
                },
                getCitytile: function (e, t) {
                    return "https://ims-s.windy.com/forecast/citytile/v1.3/" + e + "/" + t
                }
            }
        }
    )),
    ...
    W.define("format", ["trans", "store", "utils"], (function (e, t, n) {
            ...
            return i.DD2DMS = function (e, t) {
                ...
                i.seoString = function (e) {
                    return i.seoUrlString(e).replace(/\/+/g, "-")
                }
                ,
                i.seoUrlString = function (e) {
    ...
    /*! */
    W.define("pendingSubscriptionCheck", ["broadcast", "subscription"], (function (e, t) {
            var n = function () {
                t.pendingSubscription && e.emit("rqstOpen", "pending-subscription")
            };
            return e.once("dependenciesResolved", n),
                {
                    check: n
                }
        }
            ...
            return i.extend({
                ...
                _init: function () {
                    this.midnight = this.getMidnight(),
                        ...
                        this.imVersion = this.imVersion || 2,
                ...
                prepareTimesFromMinifest: function (e) {
                    return e && "object" == typeof e && e.ref && (e.dst || e.dstTime) ? (this.refTime = e.ref.replace(/(\d+)-(\d+)-(\d+)T(\d+):.*/, "$1$2$3$4"),
                        this.refTimeTxt = e.ref,
                        this.updateTxt = e.update,
                        this.refTimeTs = new Date(e.ref).getTime(),
                        this.updateTs = new Date(e.update).getTime(),
                        !0) : (window.wError("Calendar", "Invalid format of minifest " + (e.dst ? "2.0" : "3.0")),
                        !1)
                },
                    ...
                    if (e.dst) {
                        ...
                        e.dst.forEach((function (e) {
                                for (var t = e[1]; t <= e[2]; t += e[0]) {
                                    ...
                                    s <= a && (n.timestamps.push(s),
                                        n.paths.push(n.date2path(new Date(s))))
                                }
                            }
                        ))
                    } else
                        e.dstTime.forEach((function (e) {
                                var t = new Date(e);
                                n.timestamps.push(t.getTime()),
                                    n.paths.push(t.toISOString().replace(/(\d\d\d\d)-(\d\d)-(\d\d)T(\d\d):.*/, "$1$2$3$4"))
                            }
                        ));
                    return !0
                },
                date2path: function (e) {
                    return e.toISOString().replace(/(\d\d\d\d)-(\d\d)-(\d\d)T(\d\d):.*/, this.imVersion < 3 ? "$1/$2/$3/$4" : "$1$2$3$4")
                },
                ts2path: function (e) {
                ...
                path2date: function (e) {
                    var t = this.imVersion < 3 ? e.split("/") : e.split(/(.{4})(.{2})(.{2})(.{2})/g).filter(Boolean);
            ...
            return n.extend({
                ...
                _init: function () {
                    this.key = this._createKey(this.ident),
                        ...
                        this.metric = e.get(this.key),
                        e.on(this.key, this.onMetricChanged, this),
                        e.once("isImperial", this.setDefault, this)
                },
                onMetricChanged: function (e) {
                    this.metric = e,
                        t.emit("metricChanged", this.ident, e)
                },
                getDefault: function () {
                ...
                convertNumber: function (e, t, n) {
                    void 0 === t && (t = void 0),
                    void 0 === n && (n = this.metric);
                    var i = this.conv[n]
                        , s = i.conversion(e)
                        , a = void 0 !== t ? t : i.precision;
                    return a ? parseFloat(s.toFixed(a)) : Math.round(s)
                },
                ...
                setMetric: function (t) {
                    var n = this;
                    e.set(this.key, t),
                    this.cohesion && Object.keys(this.cohesion).forEach((function (i) {
                            n.cohesion[i][t] && e.set(n._createKey(i), n.cohesion[i][t])
                        }
                    ))
                },
    ...
    W.define("Color", ["utils", "store", "Class"], (function (e, t, n) {
            return n.extend({
                ...
                createGradientArray: function (e, t, n) {
                    ...
                    void 0 === t && (t = !1),
                    void 0 === n && (n = 1);
                    var i, s, a, r, o = this.steps + 1, l = new Uint8Array(o << 2),
                        c = (this.max - this.min) / this.steps, d = 0, u = this.gradient, h = 1, m = u[0], f = u[h++];
                    for (r = 0; r < this.steps; r++)
                        (i = (this.min + c * r) * n) > f[0] && h < u.length && (m = f,
                            f = u[h++]),
                            a = (i - m[0]) / (f[0] - m[0]),
                            s = this.getGradientColorYUVA(m[1], f[1], a),
                        t && this.makePremultiplied(s),
                            l[d++] = Math.round(s[0]),
                            l[d++] = Math.round(s[1]),
                            l[d++] = Math.round(s[2]),
                            l[d++] = e ? 255 : Math.round(s[3]);
                    return this.neutralGrayIndex = d,
                        l[d++] = l[d++] = l[d++] = 128,
                        l[d++] = 255,
                        l
                },
                ...
                getColor: function () {
                    var e = this;
                    return this.colors || (this.gradient = t.get(this.key),
                            this.setMinMax(),
    ...
    /*! */
    W.define("Product", ["utils", "rootScope", "colors", "http", "store", "Class", "Calendar", "Window", "rhMessage"], (function (e, t, n, i, s, a, r, o, l) {
            return a.extend({
                ident: null,
                initPromise: null,
                maxTileZoom: 10,
                ...
                _init: function () {
                    ...
                    this.productExpires = 0,
                        ...
                        this.pathGenerator = (e = {},
                            e[2] = "{server}/{directory}/{path}/257w<z>/<y>/<x>/{filename}-{level}.{fileSuffix}",
                            e[3] = "{server}/im/v3.0/{directory}/{refTime}/{path}/wm_grid_257/<z>/<x>/<y>/{filename}-{level}.{fileSuffix}",
                            e)[this.imVersion],
                        this.registerStoreKey()
                },
                registerStoreKey: function () {
                    s.insert(this.getStoreKey(), {
                        def: {},
                        save: !0,
                        allowed: function (e) {
                ...
                setMinifest: function (e) {
                    var t = this.getStoreKey()
                        , n = s.get(t);
                    this.minifest = e.forced || !n.ref || e.ref >= n.ref ? e : n,
                        s.set(t, this.minifest)
                },
                refTime: function () {
                ...
                moveTs: function (t, n) {
                    if (void 0 === n && (n = !1),
                        ...
                        if (i > -1)
                            return i = e.bound(i + (t ? 1 : -1), 0, this.acTimes.length),
                        ...
                        if (l > -1)
                            return l = e.bound(l + (t ? 1 : -1), 0, r.length),
                                s.set("timestamp", o[l], {
                                    UIident: "keyboard"
                                }),
                                !0
                ...
                loadMinifest: function (e) {
                    var n = this.getTimeFrag()
                        , s = this.server || t.server
                        , a = this.directory
                        ,
                        r = 3 === this.imVersion ? s + "/im/v3.0/" + a + "/minifest2.json?" + n : s + "/" + a + "/minifest2.json?" + n;
                    return i.get(r, {
                        cache: !e
                    })
                },
                loadInfo: function (e, n) {
                    ...
                    var a = (this.server || t.server) + "/im/v3.0/" + this.directory + "/" + (this.infoVersion || this.refTime()) + "/info.json";
                    return i.get(a, {
                        cache: !e
                    }).catch((function () {
                            return s.loadInfo(e, n - 1)
                        }
                    ))
                },
                open: function (e) {
                    var i = this;
                    return void 0 === e && (e = !1),
                    t.isMobileOrTablet || this.printLogo(),
                        this.loadingPromise ? this.loadingPromise : Date.now() < this.productExpires ? Promise.resolve(this.calendar) : (this.loadingPromise = new Promise((function (t) {
                                i.loadMinifest().then((function (t) {
                                        var n = t.data;
                                        n.refTime && (n.ref = n.refTime,
                                            delete n.refTime),
                                        (i.minifest.ref !== n.ref || e) && (i.setMinifest(n),
                                            i.infoVersion = n.info && n.info.replace(/(\d+)-(\d+)-(\d+)T(\d+):.*/, "$1$2$3$4"),
                                            i.calendar = r.instance({
                                                numOfHours: i.forecastSize,
                                                minifestFile: i.minifest,
                                                imVersion: i.imVersion
                                            }),
                                            s.set("calendar", i.calendar),
                                            s.set("lastModified", new Date(i.minifest.ref).getTime()))
                                    }
                                )).catch((function (e) {
                                        i.createBackupMinifest(),
                                        ...
                                        Object.keys(t && t.param || {}).forEach((function (e) {
                                                if (t.param[e].color) {
                                                    var i = Object.keys(n).find((function (t) {
                                                            return n[t].defaultKey === e
                                                        }
                                                    ));
                                                    n[i] && n[i].defineColor.call(n[i], t.param[e].color)
                                                }
                                            }
                                        ))
                                    }
                ...
                printLogo: function () {
                    ...
                    this.logo && (this.logoEl || (this.logoEl = document.createElement("div"),
                        ...
                        l.insert(this.logoEl))
                },
                removeLogo: function () {
                    this.logoEl && this.logo && l.remove(this.logoEl)
                },
                expire: function () {
                    this.productExpires = new Date(0)
                },
                getStoreKey: function () {
                    return "lastMinifest_" + this.directory
                }
            })
        }
    )),
    /*! */
    W.define("Product1h", ["rootScope", "http", "Product", "subscription"], (function (e, t, n, i) {
            return n.extend({
                loadMinifest: function (n) {
                    var i = this.getTimeFrag()
                        ,
                        s = (this.server || e.server) + "/" + this.directory + "/" + this.getMinifestFilename() + "?" + i;
                    return t.get(s, {
                        cache: !n
                    })
                },
                ...
                getStoreKey: function () {
                    return "lastMinifest_" + this.directory + (this.isUsingOneHourMinifest() ? "1h" : "")
                }
            })
        }
    )),
    ...
    W.define("Layer", ["Class", "products", "utils", "rootScope", "store"], (function (e, t, n, i, s) {
            return e.extend({
                ...
                getParams: function (e, a) {
                    ...
                    if (c.hasMoreLevels || (c.level = "surface"),
                    l && !l.includes(c.level) && (c.level = l[0]),
                    "100m" === c.level && "wind" !== c.overlay && (c.level = "surface"),
                    this.renderParams && (c = Object.assign(c, this.renderParams)),
                        c.refTime = o.refTime(),
                    this.product && /^cams/.test(a) && this.product !== a) {
                        var d = t.ecmwf.calendar;
                        c.path = d.ts2path(s.get("timestamp")),
                            c.refTime = d.refTime,
                            c.level = this.levels && this.levels[0] || c.level
                    }
                    return c.fullPath = n.template(this.pathGenerator || o.pathGenerator, c),
                    c.imVersion < 3 && (c.fullPath = n.addQs(c.fullPath, "reftime=" + c.refTime)),
                        c
                }
            })
        }
    ...
    W.define("Overlay", ["layers", "trans", "Class"], (function (e, t, n) {
            return n.extend({
                ...
                _init: function () {
                    ...
                    if (t) {
                        var n = t.m;
                        n && (this.convertValue = n.convertValue.bind(n),
                            this.convertNumber = n.convertNumber.bind(n),
                            this.setMetric = n.setMetric.bind(n),
                            this.cycleMetric = n.cycleMetric.bind(n),
                            this.listMetrics = n.listMetrics.bind(n),
                            this.m = n),
                            this.c = t.c,
                            this.l = t.l,
                            this.cm = t.cm
    ...
    W.define("metrics", ["Metric", "trans"], (function (e, t) {
            ...
            return {
                ...
                aod550: e.instance({
                    ...
                    description: ["AOD"],
                    lines: [[0, 0], [.25, .25], [.5, .5], [1, 1], [2, 2], [4, 4]]
                }),
                pm2p5: e.instance({
                    ident: "pm2p5",
                    defaults: ["µg/m³"],
                    ...
                    description: ["µg/m³"],
                    lines: [[0, 0], [10, 10], [20, 20], [100, 100], [1e3, 1e3]]
                }),
                no2: e.instance({
                    ident: "no2",
                    defaults: ["µg/m³"],
    ...
    W.define("layers", ["colors", "metrics", "Layer", "legends"], (function (e, t, n, i) {
            ...
            return s.capAlerts = n.instance({
                ...
                s.ecmwfWindParticles500h = n.instance({
    ...
    W.define("models", ["store", "broadcast", "$", "rootScope", "products", "layers", "overlays"], (function (e, t, n, i, s, a, r) {
            ...
            Object.keys(a).forEach((function (e) {
                    ...
                    for (var t = 0; t < d.length; t++)
                        s[d[t]].overlays.includes(e) && l[e].push(d[t])
                }
            )),
                Object.keys(r).forEach((function (e) {
                        c[e] = [];
                        for (var t = 0; t < d.length; t++)
                            s[d[t]].overlays.includes(e) && c[e].push(d[t])
                    }
                )),
            ...
            var u = function () {
                ...
                if (e.set("visibleProducts", t) && !t.includes(e.get("product"))) {
                    var n = e.get("prefferedProduct")
                        , a = e.get("overlay");
                    if (s[n].overlays.includes(a))
                        return e.set("product", n);
                ...
                , h = function (e, t) {
                var n, a, r = t ? i.localPointProducts : i.localProducts, o = [];
                for (a = 0; a < r.length; a++)
                    n = r[a],
                    s[n].pointIsInBounds(e) && o.push(n);
                return o
            };
            return {
                betterProducts: h,
    ...
    /*! */
    W.define("products", ["Product", "Product1h", "StaticProduct", "Calendar", "$", "rootScope", "radar", "satellite", "store"], (function (e, t, n, i, s, a, r, o, l) {
            var c = {}
                ,
                d = "© 2016 ECMWF: This service is based on data and products of the European Centre for Medium-range Weather Forecasts"
                ,
                u = "© Generated using Copernicus Atmosphere Monitoring Service Information [" + (new Date).getFullYear() + "]. Neither the European Commission nor ECMWF is responsible for any use of this information."
                ,
                h = '<a href="https://atmosphere.copernicus.eu/" target="_blank"><img style="max-width:150px;height:auto;" src="img/providers/copernicus-white.svg" /></a>';
            c.ecmwf = t.instance({
                ident: "ecmwf",
                ...
                _init: function () {
                    ...
                    try {
                        var n = "minifest-" + this.directory + (this.isUsingOneHourMinifest() ? "1h" : "")
                            , a = s('meta[name="' + n + '"]')
                            , r = a && a.content;
                        if (!r)
                            throw new Error("Missing minifest string");
                        if (this.setMinifest(JSON.parse(r)),
                            this.calendar = i.instance({
                                numOfHours: this.forecastSize,
                                minifestFile: this.minifest
                            }),
                            l.set("calendar", this.calendar),
    ...
    W.define("detectDevice", [], (function () {
            var e, t, n, i, s, a = window.navigator.userAgent,
                r = /android/i.test(a) ? "android" : /(iPhone|iPod|iPad)/i.test(a) ? "ios" : /windows phone/i.test(a) ? "wphone" : "desktop",
                o = (e = window.screen.width,
                    t = window.screen.height,
                    n = Math.min(e, t),
                    i = Math.max(e, t),
                    s = /ios|android/.test(r),
                    i <= 600 || i <= 960 && n <= 600 || n <= 500 && s ? "mobile" : i <= 1024 || n <= 1080 && s ? "tablet" : "desktop");
            return window.addEventListener("load", (function () {
                    document.body.classList.add("platform-" + r),
                        document.documentElement.id = "device-" + o
                }
            )),
                {
                    platform: r,
    ...
    W.define("rootScope", ["supportedLanguages", "detectDevice"], (function (e, t) {
            var n = t.platform
                ...
                pointForecast: "v2.7",
                iconsDir: "img/icons5",
                overlays: ["radarSat", "radar", "satellite", "wind", "gust", "gustAccu", "rain", "rainAccu", "snowAccu", "snowcover", "ptype", "thunder", "temp", "dewpoint", "rh", "deg0", "clouds", "hclouds", "mclouds", "lclouds", "fog", "cloudtop", "cbase", "visibility", "cape", "waves", "swell1", "swell2", "swell3", "wwaves", "sst", "currents", "airQ", "no2", "pm2p5", "aod550", "gtco3", "tcso2", "go3", "cosc", "dustsm", "fires", "pressure", "efiWind", "efiTemp", "efiRain", "capAlerts", "map"],
                ...
                airQualityProducts: ["cams", "camsEu", "geos5"],
            ...
            return a.products = a.globalProducts.concat(a.localProducts).concat(a.airQualityProducts),
                a
        }
    )),
    /*! */
    W.define("trans", ["utils", "storage", "rootScope", "store", "seoParser", "langEn"], (function (e, t, n, i, s, a) {
            ...
            "auto" !== c && e.isValidLang(c) && (d = c),
                o.loadLangFile = function (n, s) {
                    return void 0 === s && (s = i.get("usedLang")),
            ...
            function m(e) {
                ...
                Promise.all(t).then((function () {
                        o.translateDocument(document.body),
                            i.set("usedLang", e),
            ...
            o.translateDocument = function (e) {
                h.forEach((function (t) {
                        for (var n, i, s = e.querySelectorAll("[data-" + t + "]"), a = 0, r = s.length; a < r; a++)
                            switch (i = u((n = s[a]).dataset[t]),
                                t) {
                                case "t":
                                ...
                                case "tooltipsrc":
                                    ...
                                    break;
                                case "afterbegin":
                                    3 == n.firstChild.nodeType && n.removeChild(n.firstChild),
                                        n.insertAdjacentHTML(t, i);
                                    break;
                                case "beforeend":
                                    3 == n.lastChild.nodeType && n.removeChild(n.lastChild),
                                        n.insertAdjacentHTML(t, i)
                            }
                    }
                ))
            ...
            var f = function () {
                o.translateDocument(document.body),
                    m(l),
                    i.on("lang", (function (e) {
                            "auto" !== e && e !== i.get("usedLang") && m(e)
                        }
                    ))
            };
            return "loading" !== document.readyState ? f() : document.addEventListener("DOMContentLoaded", f),
                o
        }
    )),
    /*! */
    W.define("store", ["dataSpecifications", "storage", "rootScope", "Evented", "broadcast"], (function (e, t, n, i, s) {
            var a = {}
                ...
                , o = function (e, t, n) {
                return t.compare ? !t.compare(n, h(e)) : e in a ? a[e] !== n : m(e) !== n
            }
                , l = function (e, t) {
                ...
                , u = function (e, i, s, o) {
                if (null === o ? delete a[e] : a[e] = o,
                i.save && !s.doNotStore && t.isAvbl) {
                    var l = s.update || Date.now();
                    t.put("settings_" + e, o),
                    i.sync && (i.update = l,
                        t.put("settings_" + e + "_ts", l),
                        t.put("lastSyncableUpdatedItem", l)),
                    n.user && i.sync && !s.doNotSaveToCloud && r.emit("_cloudSync")
                }
                ...
                if (n in a)
                    return a[n];
                var i, s = e[n];
                return s ? (s.save && t.isAvbl ? null === (i = t.get("settings_" + n)) ? i = s.def : l(s, i) || (window.wError("store", "Attempt to get invalid value from localStorage", n),
                    i = s.def) : i = s.def,
                    a[n] = i,
                    i) : (window.wError("Trying to get invalid dataSpec. ident:", n),
                    null)
            }
                , m = function (t) {
                return e[t].def
            ...
            r.once("country", (function (e) {
                    c("hourFormat", /us|uk|ph|ca|au|nz|in|eg|sa|co|pk|my/.test(e) ? "12h" : "24h"),
                        d("isImperial", /us|my|lr/.test(e))
                }
            ));
            var f, p = t.get("UUID");
            p || (p = (f = function () {
                ...
                t.put("UUID", p));
            return h("firstUserSession") || d("firstUserSession", Date.now()),
                n.sessionCounter = h("sessionCounter201803") + 1,
                d("sessionCounter201803", n.sessionCounter),
                s.emit("identityCreated", p),
                s.emit("provisionaryToken", t.get("userToken")),
                s.on("tokenRecieved", (function (e) {
    ...
    W.define("colors", ["Color"], (function (e) {
            return {
                ...
                airQ: e.instance({
                    ...
                    steps: 2048,
                    prepare: !0,
                    default: [[0, [0, 90, 0, 255]], [51, [170, 170, 0, 255]], [101, [255, 126, 0, 255]], [151, [255, 0, 0, 255]], [201, [143, 63, 151, 255]], [301, [126, 0, 35, 255]]]
                }),
                wind: e.instance({
                    ident: "wind",
                    steps: 2048,
                ...
                satellite: e.instance({
                    ...
                    save: !1,
                    sync: !1,
                    default: [[0, [0, 0, 0, 255]], [155, [234, 234, 234, 255]], [160, [64, 64, 163, 255]], [170, [70, 106, 227, 255]], [180, [41, 187, 236, 255]], [190, [49, 241, 153, 255]], [200, [163, 253, 61, 255]], [210, [237, 208, 59, 255]], [220, [251, 128, 34, 255]], [230, [210, 49, 4, 255]], [240, [122, 4, 3, 255]], [256, [64, 0, 0, 255]]]
                }),
                fog: e.instance({
                    ident: "fog",
                    steps: 512,
    ...
    /*! */
    W.define("satellite", ["StaticProduct", "Evented", "rootScope", "http"], (function (e, t, n, i) {
            return e.instance(t, {
                ident: "satellite",
                animation: !1,
                modelName: "EUMETSAT",
                ...
                open: function () {
                    return n.isMobileOrTable || this.once("loadedAll", this.printLogo.bind(this)),
                        this.loadInfoJson(),
                        Promise.resolve()
                },
                loadInfoJson: function (e) {
                    var t = (new Date).toISOString().replace(/.*T(\d+):(\d+).*/, "$1$2")
                        , s = (this.server || n.server) + "/satellite/info.json?" + t;
                    return i.get(s, {
                        cache: !e
                    })
                }
    ...
    W.define("geolocation", ["$", "utils", "http", "store", "broadcast", "router"], (function (e, t, n, i, s, a) {
            ...
            try {
                ...
                if (u && u.content && (d = u.content.split(","))) {
                    ...
                    n.get("/node/umisteni").then((function (e) {
                            var t = e.data;
                            t && t.ll && t.ll.length && l(t.ll[0], t.ll[1], t.country, t.city, "api")
                        }
    ...
    W.define("params", ["store", "models", "overlays", "utils", "broadcast", "products", "router", "renderCtrl"], (function (e, t, n, i, s, a, r, o) {
            ...
            e.setDefault("calendar", u),
                e.setDefault("path", u.ts2path(Date.now())),
                e.defineProperty("timestamp", "syncSet", (function (t) {
                        t = parseInt(t);
                        var n = e.get("calendar");
                        return n && (t = n.boundTs(t),
                            e.set("path", n.ts2path(t))),
                            t
                    }
                )),
                e.defineProperty("product", "asyncSet", (function (t) {
                        return new Promise((function (n, s) {
                                var r = a[t];
                                a[e.get("product")].close(),
                                    r.open().then((function (s) {
                                            i.replaceClass(/product-\S+/, "product-" + t),
                                            s && (e.set("calendar", s),
                                                e.set("timestamp", i.bound(e.get("timestamp"), s.start, s.end), {
                                                    forceChange: !0
                                                })),
                                            r.levels && (e.set("availLevels", r.levels),
                                            r.levels.includes(e.get("level")) || e.set("level", "surface")),
                                            r.acTimes && (e.set("availAcTimes", r.acTimes),
                                            r.acTimes.includes(e.get("acTime")) || e.set("acTime", r.acTimes[0])),
                                                /^gfs/.test(t) ? e.set("prefferedProduct", "gfs") : /^ecmwf/.test(t) && e.set("prefferedProduct", "ecmwf"),
                                                n(t)
                                        }
                                    )).catch(s)
                            }
            ...
            var h, m = function (s) {
                var a = n[s];
                i.replaceClass(/overlay-\S+/, "overlay-" + s),
                    i.toggleClass(document.body, a && a.hasMoreLevels, "has-more-levels"),
                    e.set("availProducts", t.overlay2product[s])
            };
            e.defineProperty("overlay", "asyncSet", (function (n) {
                    var i = t.getProduct(n, e.get("product"));
                    return i === e.get("product") ? (m(n),
                        Promise.resolve(n)) : new Promise((function (t) {
                ...
                e.set("product", e.get("product"), h).then((function () {
                        ...
                        window.wError("params", "failed to launch params change", t),
                            e.set("product", "ecmwf", h),
                            e.set("overlay", "wind", h),
                            setTimeout((function () {
                                    d(),
                                        c()
                                }
                    ...
                    return new Promise((function (t) {
                            e.get("/reverse/v3/" + r + "/" + o + "/" + c + "?lang=" + l).then((function (e) {
                                    var n = e.data
                                        ...
                                        , g = a || i
                                        ,
                                        v = g && c && g !== c ? g + ", " + c : g || a || c || f || p || h && h + ", " + m || m;
                                    t({
                                        lat: r,
                                        lon: o,
                                        lang: l,
    ...
    W.define("router", ["store", "utils", "broadcast", "rootScope", "plugins", "seoParser"], (function (e, t, n, i, s, a) {
            ...
            function m(n) {
                for (var s, a = n.split(","), l = 0; l < a.length; l++) {
                    var c;
                    if (s = a[l],
                    /^-?\d+\.\d+$/.test(s) && /^-?\d+\.\d+$/.test(a[l + 1]) && /^\d+$/.test(a[l + 2]) && (r = {
                        lat: parseFloat(s),
                        lon: parseFloat(a[l + 1]),
                        zoom: parseInt(a[l + 2])
                    },
                        l += 2),
                    i.products.includes(s) && e.set("product", s),
                    i.levels.includes(s) && e.set("level", s),
                    i.overlays.includes(s) && e.set("overlay", s),
                    i.acTimes.includes(s) && e.set("acTime", s),
                    (c = /^(\d\d\d\d)-(\d\d)-(\d\d)-(\d\d)$/.exec(s)) && e.set("timestamp", Date.UTC(+c[1], +c[2] - 1, +c[3], +c[4], 0, 0, 0)),
                    (c = /^(a:?[a-zA-Z0-9]{5})/.exec(s)) && (i.customAnimation = c[1]),
                    (c = /^m:([a-zA-Z0-9]{5,})/.exec(s)) && (o = t.str2latLon(c[1])),
                    (c = /^i:([a-z0-9]{3,})/.exec(s)) && e.set("isolines", c[1]),
                    (c = /^d:picker/.exec(s)) && (o = r),
                        c = /^(\w{3,20}):(\S+)/.exec(s)) {
            ...
            l = a.purl;
            var f = window.location.search.substring(1).replace(/\?.*$/, "");
            (c = (c = decodeURIComponent(f) || "").replace(/&utm_.*$/, "")) && (/\S+=\S+/.test(c) ? d = function (e) {
            ...
            var p = h(l);
            return p ? (n.once("paramsChanged", (function () {
                    return n.emit("rqstOpen", p.plugin, p.params || d, d)
                }
            )),
                i.startupDetail = p.params || p.plugin,
                l = a.startupUrl) : l = "",
            p && p.plugin || !o || !r || (o.noEmit = !0,
                n.once("redrawFinished", n.emit.bind(n, "rqstOpen", "picker", o))),
                {
                    url: l,
                    url404: u,
                    sharedCoords: r,
    ...
    W.define("cloudSync", ["dataSpecifications", "storage", "store", "http", "utils", "broadcast", "rootScope", "colors", "metrics", "user"], (function (e, t, n, i, s, a, r, o, l, c) {
            var d = t.get("storedSettings") || 0
                , u = s.debounce(p, 2e3);
            a.on("userLoggedIn", (function () {
                    i.get("/users/settings?storeTs=" + d, {
                        cache: !1
                    }).then((function (i) {
                            var s = i.status
                                , r = i.data;
                            (t.get("lastSyncableUpdatedItem") || 0) > d && p(),
                            304 !== s && r && r.data && r.version > 1 && (!function (i) {
                                var s = !1;
                                for (var r in e)
                                    if (f(r) && h(r) in i) {
                                        var o = m(r)
                            ...
                            r.storeTs > d && (d = r.storeTs,
                                t.put("storedSettings", r.storeTs)))
                        }
            ...
            var h = function (e) {
                ...
                , f = function (t) {
                return t in e && "object" == typeof e[t] && e[t].sync
            };
            ...
            function p() {
                var s = function () {
                    ...
                    for (var r in e)
                        if (f(r)) {
                            var o = +e[i = r].update || t.get("settings_" + i + "_ts") || 0;
                            o > d && (s[h(r)] = n.get(r),
                                s[m(r)] = o,
                                a = Math.max(a, o))
                        }
                ...
                o && i.post("/users/settings", {
                    data: {
                        ...
                        d = o,
                            t.put("storedSettings", o)
                    }
                )).catch(window.wError.bind(null, "settings", "Cant save settings to the cloud"))
            }
        }
    )),
    /*! */
    ...
    W.define("ogTags", ["$", "utils"], (function (e, t) {
            var n = document.head
                , i = {
                title: e('meta[property="og:title"]', n),
                description: e('meta[property="og:description"]', n),
                url: e('meta[property="og:url"]', n),
                type: e('meta[property="og:type"]', n),
                image: e('meta[property="og:image"]', n),
                imageWidth: e('meta[property="og:image:width"]', n),
                imageHeight: e('meta[property="og:image:height"]', n),
                published: e('meta[property="article:published_time"]', n)
            }
                , s = {
                title: e('meta[name="twitter:title"]', n),
                description: e('meta[name="twitter:description"]', n),
                url: e('meta[name="twitter:url"]', n),
                image: e('meta[name="twitter:image"]', n)
            }
                , a = {}
                , r = {};
            return {
                save: function () {
                    t.each(i, (function (e, t) {
                            return e && (r[t] = e.content)
                        }
                    )),
                        t.each(s, (function (e, t) {
                                return e && (a[t] = e.content)
                            }
                        ))
                },
                set: function (e) {
                ...
                restore: function () {
                    t.each(r, (function (e, t) {
                            return i[t] && (i[t].content = e)
                        }
                    )),
                        t.each(a, (function (e, t) {
                                return s[t] && (s[t].content = e)
                            }
                        ))
                }
            }
                    ...
                    this.promise = new Promise((function (t, s) {
                            for (var a = [], r = 0; r < e.dependencies.length; r++) {
                                var o = e.dependencies[r]
                                    , l = W.plugins[o];
                                l && !l.isLoaded && a.push(l.load())
                            }
                            e.langFile && a.push(i.loadLangFile(e.langFile)),
                                Promise.all(a).then((function () {
                                        ...
                                        n.loadScript(e.getAssetsLocation()).then((function () {
                                                ...
                                                window.wError("plugin", "Failed to load plugin: " + e.ident),
                                                    e.loading = !1,
                                                    s(e)
                                            }
                                        ))
                                        ...
                                        window.wError("plugin", "Plugin error: " + e.ident, t),
                                            s()
                                    }
                                ))
                        }
    ...
    W.define("TagPlugin", ["Plugin", "Window", "trans"], (function (e, t, n) {
            return e.extend(t, {
                ...
                _unmount: function () {
                    this.unmountOnClose ? (this.node.parentNode.removeChild(this.node),
                        this.isMounted = !1) : this.node.style.display = "none"
                },
                open: function (e, t) {
                    var n = this;
    ...
    W.define("RiotPlugin", ["TagPlugin", "broadcast"], (function (e, t) {
            return e.extend({
                ...
                _unmount: function () {
                    this.unmountOnClose && this.riotTag ? (this.riotTag.unmount(),
                        this.node.parentNode.removeChild(this.node),
                        this.isMounted = this.riotTag = !1) : this.node.style.display = "none"
                },
                _open: function (e) {
                    var n = this
                        , i = this.isOpen;
                    if (!this.isOpen) {
                        ...
                        document.body.classList.add("on" + this.ident),
                            ...
                            setTimeout((function () {
                                    n.node.classList.add("open"),
                                        t.emit("pluginOpened", n.ident)
                                }
                            ), 0),
                            this.isOpen = !0
                    }
                    this.riotTag.onopen && this.riotTag.onopen(e, i),
    ...
    W.define("plugins", ["rootScope", "Plugin", "TagPlugin", "TagAutoOpen", "RiotPlugin"], (function (e, t, n, i, s) {
            var a = {
                ...
                info: n.instance({
                    ident: "info",
                    dependencies: e.isMobileOrTablet ? ["product-descriptions"] : ["rhpane", "product-descriptions"],
                ...
                subscription: n.instance({
                    ident: "subscription",
                    className: e.isMobile ? "plugin-mobile-bottom-slide" : "",
                    hasURL: !0,
                    keyboard: !0,
                    langFile: "subscription"
                }),
                "pending-subscription": n.instance({
                    ident: "pending-subscription",
                    attachPoint: e.isMobileOrTablet ? "#top-messages" : "#rh-bottom-messages",
                    hasURL: !1,
                    langFile: "subscription",
                    exclusive: "neverClose"
                }),
                "delete-info": n.instance({
                    ident: "delete-info",
                    exclusive: "lhpane",
                    hasURL: !0,
                    keyboard: !0,
    ...
    W.define("pluginsCtrl", ["rootScope", "plugins", "broadcast", "utils"], (function (e, t, n, i) {
            ...
            function a(n, a, o) {
                ...
                var l = t[n];
                l && (l.exclusive && ("all" === l.exclusive ? i.each(t, (function (e, t) {
                        e.isOpen && t !== n && r(t)
                    }
                )) : "rhpane" !== l.exclusive && "lhpane" !== l.exclusive || (t.detail.close(),
                    t.rplanner.close(),
                    t.station.close(),
                    t["webcams-detail"].close(),
                    e.isMobile ? (s(n, "rhpane"),
                        s(n, "lhpane")) : s(n, l.exclusive))),
                    l.open(a, o))
            }
            ...
            n.on("rqstOpen", a),
                n.on("rqstClose", r),
                n.on("closeAll", (function (e) {
                        void 0 === e && (e = []);
                        i.each(t, (function (t, n) {
                                t.isOpen && !e.includes(n) && r(n)
                            }
                        ))
                    }
                )),
    ...
    W.define("Bar", ["$", "utils", "Drag", "GhostBox", "Resizable", "rootScope"], (function (e, t, n, i, s, a) {
            return s.extend(n, i, {
                ...
                update: function (e) {
                    return this.left = t.bound(e, 0, this.maxWidth),
                ...
                updateGhost: function (e) {
                    ...
                    this.jumpingGhost && (this.ghost.style["margin-top"] = this.left - n < 40 && n - this.left < this.jumpingWidth ? "-25px" : "0px"),
    ...
    W.define("BindedCheckbox", ["store", "Class"], (function (e, t) {
            return t.extend({
                ...
                offValue: !1,
                _init: function () {
                    this.set(e.get(this.bindStore)),
                        this.el.onclick = this.toggle.bind(this),
                        e.on(this.bindStore, this.set, this)
                },
                unmount: function () {
    ...
    W.define("BindedSwitch", ["$", "store", "Switch"], (function (e, t, n) {
            return n.extend({
                _init: function () {
                    this.initValue = t.get(this.bindStore),
                        t.on(this.bindStore, this.set, this),
                    "function" == typeof this.render && t.on("usedLang", this.render, this),
                        n._init.call(this)
                },
                unmount: function () {
                    t.off(this.bindStore, this.set, this),
                    "function" == typeof this.render && t.off("usedLang", this.render, this)
                },
                set: function (t) {
    ...
    W.define("Drag", ["Class"], (function (e) {
            return e.extend({
                ...
                startDrag: function (e) {
                    ...
                    this.supportTouch && (window.addEventListener("touchmove", this.bindedDrag, this.passiveListener ? void 0 : {
                        passive: !1
                    }),
                ...
                endDrag: function (e) {
                    window.removeEventListener("mousemove", this.bindedDrag),
                        window.removeEventListener("touchmove", this.bindedDrag, this.passiveListener ? void 0 : {
                            passive: !1
                        }),
            ...
            return e.extend({
                ...
                startDrag: function (e) {
                    ...
                    var u = function () {
                        ...
                        Math.abs(s) > 10 && (r = .6 * s,
                            o = n.scrollEl.scrollLeft + r,
                            a = Date.now(),
                            n.inertiaAnim = window.requestAnimationFrame(h)),
                            e.preventDefault(),
                            e.stopPropagation()
                    }
                        , h = function () {
                        var e = Date.now() - a
                            , t = -r * Math.exp(-e / 325);
                        Math.abs(t) > .5 && e < 3e3 && (n.scrollEl.scrollLeft = o + t,
                            n.inertiaAnim = window.requestAnimationFrame(h))
                    }
                        , m = function (e) {
                        var t = n.getX(e);
                        n.scrollEl.scrollLeft += i - t,
                            i = t,
                            e.preventDefault(),
                            e.stopPropagation()
                    };
    ...
    /*! */
    W.define("ClickHandler", ["Class", "broadcast", "store"], (function (e, t, n) {
            var i = function (e, n) {
            ...
            return e.extend({
                defaultHandlers: {
                    ...
                    url: function (e, t, n) {
                        var i = n.href;
                        return "_blank" !== n.target && (window.location.href = i),
                            e.stopPropagation(),
                            !0
                    },
                    share: function () {
                        return t.emit("rqstOpen", "share"),
                            !0
                    },
                    login: function () {
                        return W.user.login(),
                    ...
                    logout: function () {
                        return W.user.logout(),
                            !0
                    },
                    store: function (e, t) {
                        return n.set(t[1], t[2]),
                            !0
                    }
                },
                _init: function () {
                ...
                onevent: function (e) {
                    ...
                    for (this.stopPropagation && (e.preventDefault(),
                        ...
                        if (n && n.dataset && (t = n.dataset.do)) {
                            var i = t.split(",");
                            return void (this.defaultClickHandlers(e, i, n) || this.click.apply(this, i))
                        }
                        n = n.parentNode
                    }
                },
                defaultClickHandlers: function (e, t, n) {
                    var i = t[0];
                    return i in this.defaultHandlers && this.defaultHandlers[i](e, t, n)
                }
            })
        }
    )),
    ...
    W.define("OverlaysMenu", ["overlays", "store", "trans", "rootScope", "utils", "BindedSwitch", "format"], (function (e, t, n, i, s, a, r) {
            return a.extend({
                ...
                _init: function () {
                    a._init.call(this),
                        t.on("favOverlays", this.render, this),
                        t.on("expertMode", this.render, this)
                },
                render: function () {
                    this._render(),
                        this.resize(),
                        this.set(t.get("overlay"))
                },
                resize: function () {
                },
                set: function (e) {
    ...
    /*! */
    W.define("ProductSwitch", ["BindedSwitch", "products", "store", "rootScope"], (function (e, t, n, i) {
            return e.extend({
                bindStore: "product",
                showResolution: !0,
                menu: ["arome", "nems", "iconEu", "namConus", "namHawaii", "namAlaska", "ecmwf", "ecmwfWaves", "gfs", "gfsWaves", "cams", "camsEu", "geos5"],
                _init: function () {
                    e._init.call(this),
                        n.on("availProducts", this.redraw, this),
                        n.on("visibleProducts", this.redraw, this),
                        this.redraw()
                },
                redraw: function () {
                    var e = this
    ...
    W.define("Resizable", ["utils", "broadcast", "Class"], (function (e, t, n) {
            return n.extend({
                resizableEl: null,
                _init: function () {
                    window.addEventListener("resize", e.debounce(this.resize.bind(this), 300)),
                        t.on("pluginOpened", this.uiChanged, this),
                        t.on("pluginClosed", this.uiChanged, this),
                        t.on("detailRendered", this.resize, this),
                        t.on("uiChanged", this.uiChanged, this),
                        this.rects = {
                            left: -1
                        },
                        this.resize()
                ...
                resize: function () {
                    ...
                    e.compare(t, this.rects, ["left", "right", "top", "bottom"]) || (this.height = Math.max(1, t.height),
                        this.width = Math.max(1, t.width),
                        this.rects = t,
                        this.elTop = t.top,
                        this.elBottom = t.bottom,
                        this.elLeft = t.left,
                        this.elRight = t.right,
            ...
            return e.extend({
                ...
                scrollTo: function (e) {
                    var n = this
                        ...
                        , o = function () {
                        var e = Date.now();
                        n.scrollEl.scrollLeft = t.smoothstep(s, r, e) * a + i,
                        e < r && window.requestAnimationFrame(o)
                    };
                    o()
                },
                onscroll: function () {
            ...
            return e.extend({
                ...
                touchMove: function (e) {
                    ...
                    if (!(Math.sqrt(t * t + n * n) < this.threshold)) {
                        this.xThrottled = this.x,
                            this.yThrottled = this.y;
                        var i = null;
                        Math.abs(n / t) < .2 ? i = t > 0 ? "right" : "left" : Math.abs(t / n) < .2 && (i = n > 0 ? "down" : "up"),
                        null !== i && (null === this.direction || this.direction === i ? this.direction = i : this.isSwipeValid = !1)
                    }
                },
                touchEnd: function (e) {
            ...
            return t.extend({
                ...
                click: function (t, n, i) {
                    if ("set" === t) {
                        ...
                        i || n !== this.selected && this.onset(n),
                            this.selected = n
                    } else
    ...
    /*! */
    W.define("Webcams", ["store", "map", "trans", "utils", "http", "format", "ClickHandler", "broadcast", "metrics"], (function (e, t, n, i, s, a, r, o, l) {
            return r.extend({
                maxAmount: 5,
                imgRatio: 400 / 224,
                data: [],
                ...
                _init: function () {
                    r._init.call(this),
                        this.converter = l.distance.convertValue.bind(l.distance)
                },
                ...
                load: function (t) {
                    ...
                    return this.removeMarker(),
                        this.currentLocation = L.latLng(t.lat, t.lon),
                        new Promise((function (a) {
                                s.get("/webcams/v1.0/list?" + i.qs({
                                    nearby: t.lat + "," + t.lon,
                                    lang: e.get("usedLang") || "en"
                                }), {
                                    cache: !t.forceReload
                                }).then((function (e) {
                                        var t = e.data;
                                        n.daylight = !1,
                                            t.cams.length > 0 ? (n.data = t.cams.slice(0, n.maxAmount),
                                                n.render()) : (n.data = [],
                                            n.el && (n.el.innerHTML = "")),
                                            a(n.data)
                                    }
                ...
                render: function () {
                    ...
                    if (this.data && this.data.length) {
                        ...
                        this.el.innerHTML = this.data.map((function (e, s) {
                                var r = a.howOld({
                                    ts: i && e.lastDaylight || e.lastUpdate,
                                    translate: !0
                                })
                                    , o = a.obsoleteClass((i && e.lastDaylight || e.lastUpdate) / 1e3)
                                    , l = L.latLng(e.location.lat, e.location.lon).distanceTo(t.currentLocation) / 1e3
                                    , c = l > 0 ? n.D_DISTANCE + " " + t.converter(1e3 * l, " ") : "";
                                return '<div class="webcam" data-do="webcam,' + s + '" data-webcam="' + s + '">\n\t\t\t\t<div class="webcam-inner">\n\t\t\t\t\t<div class="webcam-image" style="background-image: url( img/ajax-loader.gif );"></div>\n\t\t\t\t\t<div class="webcam-description">\n\t\t\t\t\t\t<div class="wbcm-name noselect">' + e.title + "</div>\n\t\t\t\t\t\t" + (t.singleLine ? '<small class="noselect fresh-title ' + o + '">' + r + ", " + c + "</small>" : '<small class="noselect multilined fresh-title ' + o + '">' + r + "<br />" + c + "</small>") + "\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t</div>"
                            }
                        )).join(""),
                ...
                loadImages: function () {
                    ...
                    this.forEach((function (e, i) {
                            var s = t.data[i].images[n ? "daylight" : "current"].preview;
                            e.querySelector(".webcam-image").style["background-image"] = "url(" + s + "), url( img/ajax-loader.gif )",
                                e.classList.add("loaded")
                        }
                    ))
                },
                click: function (e, t) {
                    "webcam" === e && o.emit("rqstOpen", this.toOpen, this.data[t].id)
                }
            })
        }
    )),
            ...
            return n.extend({
                ...
                close: function (e) {
                    ...
                    if (this.isOpen) {
                        ...
                        var n = function () {
                            t.closingTimer = setTimeout((function () {
                                    t.onclosed(),
                                        t._unmount(),
                        ...
                        "function" == typeof this.onclose ? Promise.resolve(this.onclose(e)).then(n) : n(),
                            this.removeHooks(),
                        this.hasURL && W.location.reset(),
                ...
                createNode: function (t) {
                    ...
                    this.className && (this.node.className = this.className),
                        this.node.innerHTML = '<div class="closing-x"></div>' + t;
                    var n = this.domEl || e(this.attachPoint);
                    this.replaceMountingPoint ? n.parentElement.replaceChild(this.node, n) : n.appendChild(this.node),
                        e(".closing-x", this.node).onclick = this.bindedClose
                },
    ...
    W.define("TimestampBar", ["BindedBar", "format", "trans"], (function (e, t, n) {
            return e.extend({
                ...
                createText: function (e) {
                    ...
                    return this.zuluMode && (e.dataset.zulu = t.hourUTC(this.timestamp)),
                    "" + a + this.displayHour(Math.round(this.numberOfHours * this.left / this.progressWidth) % 24)
                },
    ...
    /*! */
    W.define("BottomSlide", ["Drag", "Swipe", "broadcast"], (function (e, t, n) {
            return e.extend({
                preventDefault: !1,
                passiveListener: !1,
                threshold: 30,
                _init: function () {
                    var i = this;
                    e._init.call(this);
                    var s, a = this.pluginEl.querySelector(".plugin-content");
                    this.swipeHandler = t.instance({
                        el: this.pluginEl,
                        onswipestart: function () {
                            s = a.scrollTop <= 0
                        },
                        onswipe: function (e) {
                            if (s)
                                switch (e) {
                                    case "up":
                                        i.pluginEl.classList.remove("open-half");
                                        break;
                                    case "down":
                                        n.emit("rqstClose", i.pluginName)
                                }
                        }
                    })
                },
                startDrag: function (t) {
                    e.startDrag.call(this, t);
                ...
                ondrag: function (e, t, n) {
                    ...
                    Math.abs(this.throttledY - this.transformedY) > this.threshold && (this.difference = this.transformedY - this.throttledY,
                        this.throttledY = this.transformedY),
                        n.preventDefault()
                },
                ondragend: function () {
                    Math.abs(this.transformedY - this.startY) > this.threshold ? (this.pluginEl.style.transition = null,
                        this.pluginEl.style.transform = null,
                        this.difference > 0 ? n.emit("rqstClose", this.pluginName) : this.pluginEl.classList.remove("open-half")) : this.updatePosition(this.startY)
                }
            })
        }
    )),
    ...
    W.define("location", ["trans", "store", "$", "utils", "broadcast", "rootScope", "router", "picker", "overlays", "format", "plugins"], (function (e, t, n, i, s, a, r, o, l, c, d) {
            var u, h = c.seoString, m = c.seoLang, f = c.seoUrlString, p = r.url, g = Date.now(),
                v = "Windy: " + e.TITLE, y = n('meta[name="description"]') || {}, w = y && y.content, b = !1,
                T = n('link[rel="canonical"]'), L = null, S = null, E = null;
            "/" === p && (p = "");
            var A = function (e) {
                return e + (u ? "?" + u : "")
            }
                , C = function (e) {
                return T.href = i.joinPath("https://www.windy.com", e)
            }
                , M = i.emptyFun;
            ...
            )) : window.history && window.history.replaceState && (M = i.debounce((function () {
                    try {
                        var e = _();
            ...
            var _ = function () {
                ...
                return /^\/?(overlays|settings|privacy|tools|widgets|favs|hurricanes|webcams)/.test(p) && (L || S) ? S ? i.joinPath("" + m(t.get("usedLang")) + f(S), p) : L ? i.joinPath(x(), p) : void 0 : p
            }
                , x = function () {
                return m(t.get("usedLang")) + "-" + h(L)
            }
                , P = i.debounce(O, 300)
                , R = null;
            ...
            function O() {
                if (R) {
                    var e, n, s = a.map, r = [i.normalizeLatLon(s.lat), i.normalizeLatLon(s.lon), s.zoom],
                        o = t.get("timestamp");
                    "accumulations" === R.product && "next24h" !== R.acTime ? r.unshift(R.acTime) : R.path && Math.abs(g - o) > 65e6 && r.unshift(R.path.replace(/\//g, "-")),
                    "wind" !== R.overlay && r.unshift(R.overlay),
                    "surface" !== R.level && r.unshift(R.level),
                    !/^ecmwf/.test(R.product) && (n = R.overlay,
                    W.models && W.models.layer2product[n].length > 1) && r.unshift(R.product),
                    "off" !== (e = t.get("isolines")) && r.push("i:" + e),
                    a.picker && r.push("m:" + i.latLon2str(a.picker)),
                    a.customAnimation && r.push(a.customAnimation),
                        u = r.join(","),
                        M()
                }
            }
            ...
            function D() {
                if (!b) {
                    var e = t.get("overlay")
                        , n = l[e].getName();
                    "wind" === e ? (L = null,
                        document.title = v) : (L = n,
                        document.title = "Windy: " + n)
                }
            }
            ...
            return s.on("paramsChanged", (function (e) {
                ...
                s.on("mapChanged", P),
                s.on("detailRendered", P),
                o.on("pickerOpened", P),
                o.on("pickerMoved", P),
                o.on("pickerClosed", P),
                t.on("particlesAnim", P),
                t.on("overlay", D),
                t.on("usedLang", D),
                {
    ...
    /*! */
    W.define("components", ["radar", "products", "trans", "store", "query", "$", "utils", "rootScope", "broadcast", "overlays", "Class", "ClickHandler", "BindedSwitch", "BindedCheckbox", "TimestampBar"], (function (e, t, n, i, s, a, r, o, l, c, d, u, h, m, f) {
            var p;
            h.instance({
                ...
                _init: function () {
                    h._init.call(this),
                        i.on("availAcTimes", this.render, this)
                },
                render: function () {
                    ...
                    d.instance({
                        ...
                        render: function () {
                            var e = i.get("overlay")
                                ...
                                , a = i.get("level")
                                , r = [];
                            n.hasMoreLevels && "surface" !== a && r.push(o.levelsData[a][0].replace(/Pa/, "")),
                            !/ecmwf/.test(s.ident) && s.modelName && s.modelName.length && r.push(s.modelName);
                            var l = '<span class="uiyellow"\n\t\t\t\t' + (r.length ? 'data-notes="' + r.join(" ") + '"' : "") + "\n\t\t\t\t>" + n.getName() + "</span>";
                            l != this.lastString && (this.el.innerHTML = l,
                                this.el.dataset.icon = n.icon,
                                this.lastString = l)
                        }
                    }),
                    p = u.instance({
                        ...
                        scheduleClose: function (e) {
                            this.timer && clearTimeout(this.timer),
                                this.timer = setTimeout(this.close.bind(this), e)
                        },
                        open: function () {
                            var e = this;
    ...
    W.define("keyboard", ["utils", "products", "overlays", "broadcast", "store", "rootScope"], (function (e, t, n, i, s, a) {
            document.body.addEventListener("keydown", (function (r) {
                    var o, l = r.keyCode, c = !1;
                    if ((37 === l || 39 === l) && (v = t[s.get("product")],
                        o = "calendar" in v ? v : null)) {
                        var d = 39 === l;
                        o.moveTs.call(o, d, n[s.get("overlay")].isAccu),
                            c = !0
                    } else if (38 === l || 40 === l) {
                        for (var u = s.get("favOverlays"), h = s.get("overlay"), m = a.overlays.indexOf(h), f = a.overlays.length; m >= 0 && m < f;)
                            if (m += 38 === l ? -1 : 1,
                                u.includes(a.overlays[m]))
                                return void s.set("overlay", a.overlays[m]);
                        c = !0
                    } else if (33 !== l && 34 !== l || !/wind|rh|temp/.test(s.get("overlay")))
                        9 === l || 70 === l ? (i.emit("closeAll"),
                            i.emit("focusRqstd"),
                            c = !0) : 187 === l ? (i.emit("zoomIn"),
                            c = !0) : 189 === l && (i.emit("zoomOut"),
                            c = !0);
                    else {
                        var p = s.get("availLevels")
                            , g = p.indexOf(s.get("level"));
                        g > -1 && (g = e.bound(g + (33 === l ? 1 : -1), 0, p.length),
                            s.set("level", p[g])),
                            c = !0
                    }
                    var v;
    ...
    /*! */
    W.define("calendarUI", ["$", "utils", "rootScope", "trans", "store", "format", "Scrollable", "detail"], (function (e, t, n, i, s, a, r, o) {
            n.isMobile && r.instance({
                ...
                _init: function () {
                    var e = this;
                    r._init.call(this),
                        s.on("timestamp", this.set, this),
                        s.on("hourFormat", this.render, this),
                        s.on("calendar", this.render, this),
                        s.on("usedLang", this.render, this),
                        s.on("zuluMode", this.render, this),
                        window.addEventListener("resize", setTimeout.bind(null, this.render.bind(this), 500)),
                        setInterval(this.render.bind(this), t.tsHour),
                        this.render(),
                        this.set(s.get("timestamp")),
                        o.on("close", (function () {
                                e.set(s.get("timestamp"))
                            }
                        ))
                },
                render: function () {
                    var n = this;
                    if (this.calendar = s.get("calendar"),
                        this.zuluMode = s.get("zuluMode"),
                        this.localeHours = a.getHoursFunction(),
                        this.timestamp = 0,
                        this.calendar) {
                        ...
                        for (var h = 0; h < r.length; h++) {
                            var m = r[h];
                            o += "<div>&nbsp;&nbsp;" + i[m.displayLong] + "&nbsp;" + m.day + "<ul>" + c + "</ul></div>"
                        }
                        this.scrollEl.innerHTML = o;
                        var f = s.get("timestamp");
                        delete this.box.dataset.zulu,
                            this.set(f),
                            this.renderBox(),
                            e("b", this.scrollEl).style.left = window.innerWidth / 2 + (Date.now() - this.calendar.start) / this.tsPx + "px"
                    }
                },
                slideUp: function () {
                ...
                renderBox: function () {
                    this.zuluMode && (this.box.dataset.zulu = a.hourUTC(this.timestamp)),
            ...
            if (!i.isMobile) {
                ...
                s.instance(a, {
                    ...
                    _init: function () {
                        s._init.call(this),
                            a._init.call(this),
                            e.on("calendar", this.render, this),
                            e.on("usedLang", this.render, this),
                            this.onresize = this.render.bind(this),
                            this.click = e.set.bind(e, "timestamp"),
                            this.render()
                    },
                    render: function () {
                        var t = e.get("calendar");
                        if (t) {
                            var n, i = "", s = t.end, a = t.days.length, r = this.width / a, o = 100 / a;
                            if (r > 100)
                                n = this.createDayStringLong;
                            else if (r > 60)
                                n = this.createDayString;
                            else {
                                if (!(r > 40))
    ...
    /*! */
    W.define("promo", ["utils", "broadcast", "storage", "geolocation"], (function (e, t, n, i) {
            var s = n.get("promos2") || {}
                , a = e.debounce((function () {
                    n.put("promos2", s)
                }
            ), 500)
                , r = function (e) {
            ...
            return {
                getCounter: n.isAvbl ? r : function () {
                    return 1e3
                }
                ,
                getCounter2: n.isAvbl ? function (e) {
                        var t = (s[e + "_checked"] || 0) + 1;
                        return s[e + "_checked"] = t,
                            a(),
                            {
                                displayed: r(e),
                                ts: s[e + "_ts"] || 0,
    ...
    W.define("loadersUI", ["broadcast", "utils"], (function (e, t) {
            ...
            e.on("paramsChanged", (function (e, t) {
                    /^(overlay|path|level)$/.test(t) && (a(),
                        i = !1,
                        setTimeout(s.bind(null, t), 200))
                }
            )),
                e.on("redrawFinished", a),
                e.on("loadingFailed", a),
                e.on("noConnection", a)
        }
    )),
    /*! */
    W.define("user", ["rootScope", "broadcast", "http", "storage", "subscription"], (function (e, t, n, i, s) {
            function a() {
                return n.get("/users/info", {
                    cache: !1,
                    withCredentials: !0
                }).then(r).catch(l)
            }
            ...
            function r(n) {
                var i = n.data;
                i && "object" == typeof i && (i.token && (e.userToken = i.token,
                    t.emit("tokenRecieved", i.token)),
                    s.tier = s.getValidTier(i.subscriptions),
                s.tier || s.deactivateAllFeatures(),
                    i.auth && i.username ? (e.user = i,
                        e.user.avatar = o(i.avatar),
                        t.emit("rqstOpen", "user", i)) : l())
            }
            ...
            function l() {
                delete e.user,
                    s.tier = null,
                    t.emit("rqstClose", "user")
            }

            function c(t) {
                var n = document.location.href;
                return document.createElement("a").href = n,
                e.community + "/" + (t || "login") + "?return=" + encodeURI(n) + "&utm_medium=windy&utm_source=login"
            }
    ...
    W.define("timeAnimation", ["utils", "store", "products", "broadcast"], (function (e, t, n, i) {
            var s, a, r = !1, o = null, l = null, c = 2, d = !1;
            t.on("animation", (function (e) {
                    e !== r && (e ? function () {
                        if (!(l = n[t.get("product")]).animation)
                            return void f();
                        r = !0,
                            a = s = t.get("path"),
                            c = 2,
                            ...
                            t.on("product", f),
                            t.on("overlay", m),
                            i.on("redrawFinished", h),
                            i.on("paramsChanged", p),
                            i.on("pluginOpened", f),
                            g(),
                            i.emit("animationStarted")
                    }() : (r = !1,
                        clearTimeout(o),
                        t.off("visibility", u),
                        t.off("product", f),
                        t.off("overlay", m),
                        i.off("redrawFinished", h),
                        i.off("paramsChanged", p),
                        i.off("pluginOpened", f)))
                }
            ));
            var u = function (e) {
                e || f()
            ...
            function g() {
                ...
                var n = t.get("timestamp") + 50 * l.animationSpeed * c;
                n < l.calendar.end ? (t.set("timestamp", n),
                    o = setTimeout(g, 50)) : f()
            }
        }
    )),
    /*! */
    W.define("hp", ["map", "utils", "urls", "store", "query", "rootScope", "geolocation", "http", "broadcast", "storage"], (function (e, t, n, i, s, a, r, o, l, c) {
            var d = !1
                , u = !1
                , h = i.get("showWeather")
                , m = e.getContainer();
            ...
            function p() {
                document.body.addEventListener("mousedown", g, !1),
                    ...
                    document.body.addEventListener("keydown", g, !1),
                    m.addEventListener("click", g, !0),
                    m.addEventListener("touchstart", g, !0),
                    u = !0
            }
            ...
            function g(e) {
                if (e && e.target) {
                    ...
                    if ("search-my-loc" === e.target.id)
                        return s.showLoader(),
                            void r.getGPSlocation().then(v).catch(s.hideLoader.bind(s))
                }
                document.body.removeEventListener("mousedown", g, !1),
                    document.body.removeEventListener("touchstart", g, !1),
                    document.body.removeEventListener("keydown", g, !1),
                    m.removeEventListener("click", g, !0),
                    m.removeEventListener("touchstart", g, !0),
                    u = !1,
                    d = !0,
            ...
            function v(e) {
                if (!d) {
                    u || p();
                    var s = t.normalizeLatLon(e.lat) + "/" + t.normalizeLatLon(e.lon)
                        , a = n.getPointForecast("ecmwf", e, "hp", "setup=summary&includeNow=true")
                        , r = {
                        wx: o.get(a, {
                            cache: !1
                        }),
                        capAlerts: o.get("/capalerts/" + s + "?lang=" + i.get("usedLang"), {
                            cache: !1
                        })
                    };
            ...
            return a.isResumed || !h || a.startupDetail ? document.body.classList.remove("onweather") : f(),
                l.on("back2home", (function () {
                        l.emit("closeAll", ["hp-weather"]),
                            i.set("timestamp", Date.now()),
                            d = !1,
                            r.getHomeLocation((function (t) {
                                    v(t),
                                        t.zoom = 5,
                                        e.center(t)
                                }
                ...
                l.emit("log", "weather/" + (h ? i.get("startUp") : "userDisabled")),
                {
                    cancelShow: function () {
                        return d
                    },
    ...
    /*! */
    W.define("permanentPromos", ["utils", "$", "rootScope", "broadcast", "geolocation", "subscription", "store", "trans"], (function (e, t, n, i, s, a, r, o) {
            var l = document.body.classList;

            function c(s, a) {
                if (Math.abs(s - Date.now()) < 72 * e.tsHour && ("keyboard" === a || "main" === a || "botomCal" === a)) {
                    var r = i.emit.bind(i, "rqstOpen", "subscription")
                        , c = document.createElement("DIV");
                    if (c.textContent = o.D_1H_FORECAST,
                        c.id = "bottom-promo-1h",
                        c.title = "",
                        c.className = "checkbox uiyellow off",
                        c.addEventListener("touchstart", r),
                        c.addEventListener("click", r),
                        n.isMobile) {
                        var d = t("#mobile-calendar");
                        l.add("hide-mobile-logo"),
                            setTimeout((function () {
                            ...
                            setTimeout((function () {
                                    return l.remove("hide-mobile-logo")
                                }
                            ), 20900)
                    } else {
                        var u = t("#progress-bar > .timecode.main-timecode");
                        u.appendChild(c),
                            setTimeout((function () {
            ...
            i.once("dependenciesResolved", (function () {
                    setInterval((function () {
                            l.add("animate-logo"),
                                setTimeout((function () {
                                        return l.remove("animate-logo")
                                    }
                                ), 2e3)
                        }
                    ), 3e4)
            ...
            !n.isMobile || "ios" !== n.platform && "android" !== n.platform || i.once("dependenciesResolved", (function () {
                    var e = ["#d49500", "#d40000", "#d4009b", "#8400d4", "#2200d4", "#0d869a", "#177900", "#ad7100"]
                        , n = 0;
                    setInterval((function () {
                            ++n >= e.length && (n = 0),
                                t("#open-in-app").style["background-color"] = e[n]
                        }
                    ), 12e3)
                }
            )),
            a.hasAny() || i.once("redrawFinished", (function () {
                    r.once("timestamp", c)
                }
            )),
            n.isMobile && i.once("hpHidden", (function () {
                    l.add("mm-show"),
                        l.remove("mm-hide"),
                        setTimeout((function () {
                                return l.add("mm-smaller")
                            }
                        ), 3e3),
                        setTimeout((function () {
                                return l.remove("mm-show")
                            }
                        ), 1e4),
                        setTimeout((function () {
                                return l.add("mm-hide")
                            }
                        ), 13e3)
                }
            ))
            ...
            return t.extend({
                ...
                open: function (t) {
                    ...
                    return this.isMounted ? Promise.resolve() : this.isLoaded ? (this.onopen(t),
                        this.isMounted = !0,
                        Promise.resolve()) : (this.loadingPromise || (this.loadingPromise = new Promise((function (i) {
    ...
    W.define("DataTiler", ["utils", "map", "dataLoader", "render", "Class", "rootScope"], (function (e, t, n, i, s, a) {
            return s.extend({
                ...
                getTiles: function (n) {
                    ...
                    if (Math.floor(r) === r) {
                        this.syncCounter++;
                        for (var o = t.getPixelBounds(), l = [], c = o.min.x >> 8, d = o.max.x >> 8, u = o.min.y >> 8, h = o.max.y >> 8, m = u; m <= h; m++)
                            for (var f = c; f <= d; f++) {
                ...
                postProcess: function (e, t, n, s) {
                    if (e === this.syncCounter) {
                        ...
                        this.trans = 0 | i.getTrans(t.zoom, t.dZoom),
                        ...
                        r < 0 && (r = 256 + r),
                            this.offsetX = r * this.trans | 0,
                            this.offsetY = o * this.trans | 0,
                            this.offset = 2056,
                            this.width = t.width,
                            this.height = t.height,
                            this.w = i.getWTable(this.trans),
                            this.tilesReady.call(this, a, t, n)
                    }
                },
                sortTiles: function (e, n, s) {
                    ...
                    }, d = e.origTiles.minY; d <= e.origTiles.maxY; d++)
                        c(d);
                    return l
                }
            })
    ...
    W.define("TileLayerCanvas", ["rootScope", "render", "utils", "dataLoader", "renderTile"], (function (e, t, n, i, s) {
            return L.GridLayer.extend({
                ...
                onAdd: function (e) {
                    L.GridLayer.prototype.onAdd.call(this, e),
                ...
                onRemove: function (e) {
                    e.off("movestart", this.onMoveStart, this),
                        ...
                        t.emit("toggleSeaMask", this.hasSea)
                },
                ...
                redrawTile: function (e) {
                    ...
                    i.loadTile(s).then((function (t) {
                            n.renderTile.call(n, 2, e.el, a, s, t),
                            --n._tilesToLoad || n.redrawFinished()
                        }
                    )).catch(console.error)
                },
                paramsChanged: function (e) {
                    e.fullPath === this.latestParams.fullPath && e.layer === this.latestParams.layer || (this.latestParams = n.clone(e),
                        this.syncCounter++,
                        this.redrawLayer())
                },
                sortTilesFromCenterOut: function (e) {
                    var t, n, i = [], s = e.getCenter(), a = this._tileZoom;
                ...
                redrawFinished: function () {
                    this.latestParams.sea !== this.hasSea && (n.toggleClass(document.body, this.latestParams.sea, "sea"),
                        this.hasSea = this.latestParams.sea,
                        t.emit("toggleSeaMask", this.hasSea)),
                        t.emit("rendered", "tileLayer")
                },
                createTile: function (e, n) {
                    ...
                    var a = t.whichTile(e, this.latestParams)
                        ...
                        , o = this.syncCounter;
                    return r.width = r.height = 256,
                        i.loadTile(a).then((function (e) {
                                r.style.width = r.style.height = "256px",
                                    s.renderTile.call(s, 2, r, o, a, e),
                                    n(void 0, r)
                            }
                        )).catch(n),
                        r
    ...
    /*! */
    W.define("dataLoader", ["lruCache", "rootScope", "utils", "broadcast"], (function (e, t, n, i) {
            var s = new e(50)
                , a = 0
                , r = t.isMobile ? 3 : 6;
                            ...
                            c.crossOrigin = "Anonymous",
                                c.onload = function () {
                                    ...
                                    e.data = n.data,
                                        e.status = "loaded";
                                    var i = function (e, t) {
                                        var n, i, s, a, r = new ArrayBuffer(28), o = new Uint8Array(r),
                                            l = new Float32Array(r), c = 4 * t * 4 + 8;
                                        for (a = 0; a < 28; a++)
                                            n = e[c],
                                                i = e[c + 1],
                                                s = e[c + 2],
                                ...
                                c.onerror = function () {
                                    e.status = "failed",
                                        i.emit("loadingFailed", e.url),
                                    ++a > r && (i.emit("noConnection"),
                                        a = 0),
                                        s("Failed to load tile")
                                }
                                ,
                                c.src = e.url,
    ...
    W.define("renderCtrl", ["renderers", "layers", "overlays", "broadcast", "utils", "render"], (function (e, t, n, i, s, a) {
            ...
            i.on("paramsChanged", (function (i) {
                    ...
                    d.forEach((function (t) {
                            var n = e[t.renderer];
                            n.isMounted ? n.paramsChanged.call(n, t.params) : m.push(n.open.call(n, t.params))
                        }
                    )),
                    m.length > 0 && Promise.all(m).catch(window.wError.bind(null, "renderCtrl", "Unable to load render"));
                    l = d.length,
                        c = setTimeout(h, 5e3)
                }
            )),
    ...
    W.define("interpolator", ["renderers"], (function (e) {
            ...
            return function (n) {
                var i = function () {
                    for (var t in e) {
                        var n = e[t];
                        if (n.isMounted && "interpolator" in n)
                            return n.interpolator
                    }
                }();
        ...
        return i.instance({
            ...
            tilesReady: function (n, i, s) {
                var a = this
                    ...
                    if (s.PNGtransparency && t.testPNGtransparency(g, v))
                        return NaN;
                    if (s.JPGtransparency && t.testJPGtransparency(g, v))
                        return NaN;
                    var y = g[v]
                        , w = g[v + 4]
                        , b = g[v + 1]
                        ...
                        , I = (y * P + w * R + E * O + A * D) / N
                        ,
                        k = s.interpolateNearestG ? t.interpolateNearest(null, 0, b, T, C, M, P, R, O, D) : (b * P + T * R + C * O + M * D) / N
                        , W = (L * P + S * R + _ * O + x * D) / N;
                    return [p.decodeR(I), p.decodeG(k), p.decodeB(W)]
                };
                this.cb((function (t) {
                        var n = t.lat
                            , i = t.lon
...
W.define("renderTile", ["render", "layers"], (function (e, t) {
        return function (n, i, s, a, r) {
            if (s === this.syncCounter) {
                Date.now();
                n |= 0;
                var o, l = this.latestParams, c = l.isMultiColor, d = r.data, u = i.getContext("2d"),
                    h = e.imgData.data;
                "png" === l.fileSuffix ? l.PNGtransparency && (o = e.testPNGtransparency) : l.JPGtransparency && (o = e.testJPGtransparency);
                var m, f, p, g, v, y, w, b, T, L, S, E, A = !1, C = 0 | a.trans, M = 0 | Math.log2(C),
                    _ = 0 | Math.log2(C * C), x = 0 | a.intX, P = 0 | a.intY, R = 256 >> M, O = e.getWTable(C), D = 0,
                    N = 0, I = x * R | 0, k = P * R | 0, U = 0, F = 0, G = 256, H = 0, z = 0, B = 0, j = 0, V = 0,
                    q = 0, Y = 0, Z = 0, Q = 0, X = 0, $ = 0, J = t[l.layer], K = "B" === l.renderFrom,
                    ee = "RG" === l.renderFrom, te = r.decodeR, ne = r.decodeG;
                for (c ? (T = e.createCombinedFillFun(h, J.getColor(), J.getColor2(), J.getAmountByColor),
                    L = e.createFillFun(h, n, J.getColor())) : T = L = e.createFillFun(h, n, J.getColor()),
                     K && (te = r.decodeB),
                         E = 0; E < 256; E += n)
                    for (B = E - ((F = E >> M) << M),
                             S = 0; S < 256; S += n)
                        z = S - ((U = S >> M) << M),
                        G !== U && (N = 2056 + U + I + (((H = F + k) << 8) + H) << 2,
                        void 0 !== o && (A = o(d, N)),
                        !0 === K && (N += 2),
                            j = d[N],
                            V = d[N + 4],
                        ...
                        !0 === ee && (Z = d[N + 1],
                            ...
                            $ = d[N + 1033]),
                            G = U),
                            A ? L(S, E, NaN) : (w = te(null !== O ? j * O[D = z + (B << M) << 2] + V * O[D + 1] + q * O[D + 2] + Y * O[D + 3] >> _ : j * (m = (1 - (v = z / C)) * (1 - (y = B / C))) + V * (f = v * (1 - y)) + q * (p = y * (1 - v)) + Y * (g = v * y)),
                            !0 === ee && (b = ne(null !== O ? Z * O[D] + Q * O[D + 1] + X * O[D + 2] + $ * O[D + 3] >> _ : Z * m + Q * f + X * p + $ * g)),
                                c ? T(S, E, w, b) : T(S, E, ee ? Math.sqrt(w * w + b * b) : w));
                u.putImageData(e.imgData, 0, 0),
                "pattern" in l && l.pattern in W && W[l.pattern].addPattern(u, C, d, 2056, I, k, R, te, ne)
            }
        }
    }
)),
...
W.define("GlObj", [], (function () {
        ...
        return e.getNextPowerOf2Size = function (e) {
            ...
            ,
            e.littleEndian = (t = new ArrayBuffer(2),
            ...
            e.prototype = {
                ...
                deleteProgramObj: function (t) {
                    e.removeFromArray(t, this.programs),
                        this.get().deleteProgram(t)
                },
                ...
                deleteTexture2D: function (t) {
                    e.removeFromArray(t, this.textures),
                        this.get().deleteTexture(t)
                },
                ...
                deleteBuffer: function (t) {
                    e.removeFromArray(t, this.buffers),
                        this.get().deleteBuffer(t)
                },
            ...
            initWebGl: function () {
                ...
                try {
                    ...
                    e = this.glo.create(t, {
                        ...
                        this.it.gl = e,
                        e ? this.it.framebuffer = this.glo.createFramebuffer() : window.WebGLRenderingContext ? this.status = "error-no-WebGL-context" : this.status = "error-no-WebGL-browser"
                } catch (e) {
...
W.define("ImageGraph", ["ImageMaker"], (function (e) {
        return e.extend({
            ...
            createGradient: function (e, t, n) {
                for (var i, s, a = this.fillColors.length, r = this.fillColors[0][0], o = this.fillColors[a - 1][0], l = 1 / (o - r), c = this.h / (e - t), d = c * (o - t), u = c * (r - t), h = this.ctx.createLinearGradient(0, u, 0, d), m = 0; m < a; ++m)
                    s = this.fillColors[m][1],
                        i = l * (this.fillColors[m][0] - r),
            ...
            render: function (e, t) {
                void 0 === t && (t = 1),
                    this.checkData(e);
                var n, i, s = this.ctx, a = e.length, r = this.tdWidth, o = r >> 1, l = this.h, c = [], d = -r - o,
                    u = this.viewport || this.findMinMax(e), h = u[0], m = u[1];
                for (i = 0; i < a + 4; ++i)
                    n = e[Math.max(0, Math.min(i - 2, a - 1))],
                        c.push([d, this.getY(n, h, m, l), n]),
                        d += r;
                for (i = 0; i < a; ++i)
                ...
                return s.lineTo(c[a + 2][0], l),
                    this.fillColors ? (s.fillStyle = this.createGradient(h, m, t),
        ...
        return r.extend({
            ...
            renderRainSnow: function () {
                for (var e = this.dataLength, t = "", n = this.data.snow, i = this.data.mm, s = 0; s < e; s++) {
                    var a = null;
                    n[s] && i[s] > .1 ? a = "&#xe000" : !n[s] && i[s] > .5 && (a = "&#xe006"),
            ...
            renderFragment: function (e, s, a) {
                void 0 === a && (a = {}),
                    this.options = a,
                s && this.weatherData(s, a);
                var r = t("table", e)
                    , o = r.clientWidth / this.dataLength;
                n.temp.init(t("canvas", e), this.dataLength, o, a.bgHeight).render(this.data.temp, .5).maskEnds(10),
                    t(".slider", e).style.background = this.renderSlider(),
                    r.innerHTML = "<tr> " + this.renderSliderDays() + "</tr>";
                var l = t(".alerts-line", e);
                if (a.timestamps && l ? (l.style.background = this.renderAlert(a.timestamps),
                    l.style.display = "block") : l && (l.style.display = "none"),
                    a.addRain) {
...
W.define("searchCtrl", ["$", "broadcast", "results", "query", "utils"], (function (e, t, n, i, s) {
        ...
        a.onmousedown = c,
            e("#search .cancel-search").onmousedown = o,
            i.element.onblur = o,
            i.element.onfocus = function () {
                r.hasFocus = !0,
                    i.element.addEventListener("keydown", d),
                    i.element.addEventListener("keyup", l),
                i.element.value.length > 3 && a.classList.add("show");
                t.emit("closeAll"),
        ...
        function o() {
            r.hasFocus = !1,
                n.hide(),
                i.element.removeEventListener("keydown", d),
                i.element.removeEventListener("keyup", l),
        ...
        function l(e) {
            ...
            i.value !== t && (s.toggleClass(a, t.length > 2, "show"),
                i.put(t),
                n.show())
        }
        ...
        function d(e) {
            var t = e.keyCode;
            27 === t ? i.value ? c() : i.element.blur() : n.onkeypress(t, e),
                e.stopPropagation()
        }
...
/*! */
W.define("results", ["store", "$", "utils", "broadcast", "map", "recents", "query", "http", "geolocation", "Favs"], (function (e, t, n, i, s, a, r, o, l, c) {
        return {
            el: t("#search"),
            marker: null,
            isOpen: !1,
            ...
            onkeypress: function (e, n) {
                ...
                switch (e) {
                    ...
                    case 9:
                    case 13:
                        (i = t(".active", this.element)) ? this.doAction(i, n) : (this.colorize(null, 0),
                            setTimeout(this.doAction.bind(this, t(".active", this.element), n), 1e3))
                }
            },
            doAction: function (e, t) {
                ...
                t && (t.preventDefault(),
                    t.stopPropagation()),
                    "next" === n ? this.show(this.data, parseInt(i)) : this.fireAction(this.data[i]))
            },
            fireAction: function (e) {
                ...
                i.emit("rqstOpen", t, n.clone(e)),
                    this.hide(),
                    r.element.blur(),
                    i.emit("log", "search/" + (e.key ? "recents" : "results")),
                    a.addItem(e, s)
            },
            ...
            load: function () {
                ...
                r.showLoader(),
                    ...
                    o.get("/search/v3.1/" + this.pos.lat + "/" + this.pos.lon + "/" + r.get().replace(/\//g, " ") + "?lang=" + this.lang).then((function (t) {
                            var n = t.data;
                            void 0 === n && (n = {}),
                                r.hideLoader(),
                                e.hits = n.data,
                                "2airports" === (n.header && n.header.type) ? i.emit("rqstOpen", "distance", e.hits) : e.display()
                        }
                    )).catch((function () {
                            r.hideLoader()
                        }
            ...
            show: function () {
                var t = this
                    , n = r.get();
                this.pos = l.getMyLatestPos(),
                    this.lang = e.get("usedLang"),
                    this.recents = a.loadRecents(n),
                    this.hits = [],
                ...
                n.length > 1 && (this.clickTimer = setTimeout((function () {
                        return t.load(n)
                    }
                ), 300))
            },
            display: function () {
                var t = e.get("country")
                    , n = this.mixRatio[r.get().length] || 1;
                if (this.elementData.innerHTML = "",
                    this.recents = this.recents.slice(0, n),
                ...
                for (var s = 0, a = Math.min(this.data.length, this.maxResults); s < a; s++) {
                    var o = this.data[s]
                        , l = o.title
                        , d = void 0;
                    l === o.region && (o.region = null),
                    (l === o.country || "us" !== o.cc && t === o.cc) && (o.country = null),
                        o.icao ? d = o.icao : "wx" === o.type && o.stationId ? (d = o.stationId.replace(/^.*-/, ""),
                            l = "Wx station: " + (l || d)) : d = o.region && o.country ? o.region + ", " + o.country : o.country || o.region || "";
                    var u = this.newItem("hit", s, s, o.type, l + (d ? " <span>" + d + "</span>" : ""));
                    u.style.opacity = this.opacity[s],
                        this.elementData.appendChild(u)
                }
            },
            hide: function () {
                this.isOpen = !1,
                    ...
                    this.element.classList.remove("wide"),
                this.marker && s.removeLayer(this.marker),
                    this.image.src = n.emptyGIF
            },
            mapizeTimeout: null,
            mapize: function (e) {
                var t = this;
                if (e && "hit" === e.dataset.name) {
                    ...
                    this.marker = L.marker([r, o], {
                        icon: s.myMarkers.icon
                    }).addTo(s),
                        this.element.classList.add("wide"),
                        clearTimeout(this.mapizeTimeout),
                        this.mapizeTimeout = setTimeout((function () {
                                t.element.classList.add("waiting")
                            }
                        ), 300),
                        this.image.onload = function () {
                            clearTimeout(t.mapizeTimeout),
                                t.element.classList.remove("waiting"),
                                n.toggleClass(t.imageBox, !l, "show-pointer")
                        }
                        ,
                        ...
                        ,
                        this.image.src = "https://node-s.windy.com/imaker/map" + (l ? "?bbox=" + l : "?c=" + r + "," + o + "&z=10"),
                        this.image.dataset.value = i
                }
            }
        }
    }
...
W.define("recents", ["Favs", "favs"], (function (e, t) {
        return e.instance({
            ...
            loadRecents: function (e) {
                var n, i, s;
                return i = this.get(2, e, "timestamp"),
                    n = this.get(7, e, "counter", i),
                    i = i.concat(n),
                    s = t.get(7, e, "counter", i),
                    i.concat(s)
            },
            _init: function () {
                this.load()
        ...
        return t.extend({
            ...
            activate: function () {
                this.isActive = !0,
                    ...
                    this.download(),
                    e.on("zoomstart", this.delete, this),
                    e.on("zoomend", this.render, this)
            },
            deactivate: function () {
                this.isActive = !1,
                    this.lastUrl = null,
                    ...
                    e.off("zoomstart", this.delete, this),
                    e.off("zoomend", this.render, this)
            },
...
W.define("Favs", ["storage", "utils", "Class"], (function (e, t, n) {
        return n.extend({
            ident: null,
            key: function (e) {
                return "string" == typeof e ? e : e.key ? e.key : "station" === e.type ? e.id : "webcam" === e.type ? e.webcamId : "airport" === e.type || e.icao ? e.icao : "alert" === e.type || e.alertId ? e.alertId : t.normalizeLatLon(e.lat) + "/" + t.normalizeLatLon(e.lon)
            },
            add: function (e) {
                if (!t.isValidLatLonObj(e))
                    return !1;
                var n = this.key(e)
                    , i = {
                    key: n,
                ...
                return "alert" === e.type ? i.alertId = e.alertId : "airport" === e.type ? i.icao = e.icao : "station" === e.type ? i.stationId = e.stationId || e.id || e.key : "webcam" === e.type && (i.webcamId = e.webcamId),
                    this.data[n] = i,
                    this.onchange(),
                    this.save(),
                    !0
            ...
            get: function (e, n, i, s) {
                ...
                )) : null, c = this.sortFavs(n, i, l), d = 0; d < Math.min(e, c.length); d++)
                    r = c[d],
                    (a = t.clone(this.data[r])).title || (a.title = a.name),
                        o[d] = a;
                return o
            }
        })
...
W.define("WindyMap", ["utils", "rootScope"], (function (e, t) {
        return L.Map.extend({
            ...
            setZoomCenter: function (e, t) {
                return this._zoomCenter = L.point(e, t),
                    this
            },
            removeZoomCenter: function () {
                return this._zoomCenter = void 0,
                    this
            }
        })
    }
...
/*! */
W.define("LabelsLayer", ["products", "http", "urls", "rootScope", "utils", "overlays", "store", "broadcast", "singleclick"], (function (e, t, n, i, s, a, r, o, l) {
        return L.GridLayer.extend({
            options: {
                minZoom: 3,
                maxZoom: 11,
                ...
                updateWhenIdle: !0,
                updateWhenZooming: !1,
                keepBuffer: i.isMobileOrTablet ? 2 : 4
            },
            tempConverter: a.temp.convertNumber,
            cityDivs: {},
            latestTs: 0,
            latestIndex: 0,
            ts: r.get("timestamp"),
            ...
            onAdd: function () {
                this.hasHooks || (this.updateProduct(),
                    this.createTilesUrl(),
                    l.on("poi-label", this.onClick, this),
            ...
            createTilesUrl: function () {
                ...
                this.tilesUrl = i.tileServer + "/labels/v1.3/" + e
            },
            ...
            updateProduct: function (t) {
                ...
                var i = e[n].refTime();
                if ((this.product !== n || this.refTime !== i) && (this.product = n,
                    this.refTime = i,
                    t))
                    for (var s in this.cityDivs)
                        this.loadFcstTile(this.cityDivs[s])
            },
            ...
            onTsChange: function (e) {
                Math.abs(e - this.ts) > 1.5 * s.tsHour && (this.ts = e,
                    this.refreshWeather())
            },
            toArray: function () {
                var e = [];
            ...
            loadFcstTile: function (e) {
                e.labels.length && t.get(n.getCitytile(this.product, e.urlFrag)).then(this.onFcstLoaded.bind(this, this.syncCounter, e)).catch((function (e) {
                        0
                    }
                ))
            },
            ...
            createTile: function (e, n) {
                ...
                return a.style.width = a.style.height = this.getTileSize() + "px",
                    a.onselectstart = a.onmousemove = L.Util.falseFn,
                    t.get(this.tilesUrl + "/" + s + ".json").then(this.onTileLoaded.bind(this, this.syncCounter, e, a)).then((function (e) {
                            e && (e.urlFrag = s,
                                i.loadFcstTile(e),
                                n(void 0, a))
                        }
            ...
            renderTile: function (e, t, n) {
                for (var i = this._getTilePos(t), a = i.x, r = i.y, o = this._map.getPixelOrigin(), l = o.x, c = o.y, d = 256 << t.z, u = [], h = 0; h < n.length; ++h) {
                    var m = n[h]
                        , f = m[0]
                        , p = m[1]
                        , g = m[2]
                        ...
                        , b = m[6]
                        , T = "ci" !== g.substr(0, 2)
                        , L = T ? f : y.toFixed(2) + "/" + v.toFixed(2)
                        , S = Math.floor(s.lonDegToXUnit(v) * d - l - w / 2) - a
                        , E = Math.floor(s.latDegToYUnit(y) * d - c - b / 2) - r
                        , A = document.createElement("div");
                    A.textContent = A.dataset.label = p,
                        A.dataset.id = L,
                        A.dataset.poi = "label",
                        A.className = g,
                        A.style.transform = "translate(" + S + "px, " + E + "px)",
                        A.style.width = w + "px",
                    T || u.push({
                        id: L,
                        el: A
            ...
            renderWeather: function (e, t, n) {
                ...
                if (i)
                    if (a && a.length) {
                        var r = this.ts - e
                            , o = Math.round(r / (t * s.tsHour));
                        o >= 0 && o < a.length ? i.dataset.temp = this.tempConverter(a[o]) + "°" : delete i.dataset.temp
                    } else
...
W.define("map", ["render", "plugins", "WindyMap", "rootScope", "utils", "store", "broadcast", "geolocation", "router"], (function (e, t, n, i, s, a, r, o, l) {
        ...
        var c, d = 0,
            u = l.sharedCoords || ("location" === a.get("startUp") ? a.get("homeLocation") : o.getMyLatestPos());
        ...
        function g() {
            ...
            a !== d && (s.replaceClass(/zoom\d+/, "zoom" + a),
                d = a),
                r.emit("mapChanged", i.map)
        }

        function v() {
            var e = {
                graymap: i.tileServer + "/tiles/v9.0/darkmap" + (i.isRetina ? "-retina" : "") + "/{z}/{x}/{y}.png",
                sznmap: "https://windytiles.mapy.cz/turist-en/{z}-{x}-{y}",
                winter: "https://mapserver.mapy.cz/winter-m/{z}-{x}-{y}",
                satLocal: i.tileServer + "/tiles/orto/v1.0/{z}/{z}-{x}-{y}.jpg",
                sat: "https://{s}.aerial.maps.api.here.com/maptile/2.1/maptile/newest/satellite.day/{z}/{x}/{y}/256/jpg?" + i.hereMapsID
            }
                , t = a.get("map")
                , n = null;
            n = "map" !== a.get("overlay") || h ? "sat" === t ? {
                11: {
                    url: e.graymap
                },
                13: {
            ...
            c.baseLayer && c.removeLayer(c.baseLayer),
                c.baseLayer = L.tileLayerMulti(n, {
                    detectRetina: !1,
                    minZoom: 3,
                    maxZoom: 18,
                    updateWhenIdle: !!i.isMobileOrTablet,
...
W.define("singleclick", ["map", "Evented", "rootScope", "store", "broadcast", "plugins"], (function (e, t, n, i, s, a) {
        ...
        return t.instance({
            ...
            _init: function () {
                ...
                r && i.on("hpShown", this.hpShown, this)
            },
            hpShown: function (e) {
                var t = this;
...
W.define("favs", ["$", "store", "picker", "http", "broadcast", "utils", "Favs", "Evented"], (function (e, t, n, i, s, a, r, o) {
        return o.instance(r, {
            ...
            latestParams: {},
            triggeredAlerts: 0,
            types: ["alert", "station", "fav", "airport", "webcam"],
            _init: function () {
                o._init.call(this),
                    this.load(),
            ...
            add: function (e) {
                e.type && !this.types.includes(e.type) && delete e.type,
                    r.add.call(this, e)
            },
            getAlert: function (e) {
                if ("string" == typeof e)
                        ...
                        i.get("/users/alertCheck/" + e.alertId, {
                            cache: !1
                                ...
                                var s = i.data
                                    , a = !1;
                                if ("missing" === s.status)
                                    console.warn("Deleting the fav", e.alertId),
                                        t.remove(e.alertId);
                                else {
                                    var r = s.alert
                                        , o = s.timestamps || [];
...
W.define("pois", ["Poi", "utils", "broadcast", "favs", "singleclick"], (function (e, t, n, i, s) {
        ...
        return a.empty = e.instance({
            ...
            a.favs = e.instance({
                ...
                _init: function () {
                    e._init.call(this),
                        i.on("favsChanged", this.repaint, this),
                        s.on("poi-favs", this.onclick, this)
                },
                repaint: function () {
...
W.define("poisCtrl", ["pois", "store", "utils", "broadcast", "plugins"], (function (e, t, n, i, s) {
        ...
        function r(e) {
            "favs" !== e && "empty" !== e ? (t.off("pois", r),
                s["poi-libs"].open().then((function () {
                        o(e);
                        var s = n.debounce(c, 1500);
                        i.on("paramsChanged", s),
                            i.on("mapChanged", s),
                            i.on("metricChanged", l),
                            t.on("pois", o)
                    }
                ))) : o(e)
        }
        ...
        function o(t) {
            n.replaceClass(/selectedpois-\S+/, "selectedpois-" + t),
                e[a].deactivate(),
                e[t].activate(),
                "empty" === t && e.favs.isActive ? e.favs.deactivate() : "empty" === t || e.favs.isActive || e.favs.activate(),
                a = t
        }
